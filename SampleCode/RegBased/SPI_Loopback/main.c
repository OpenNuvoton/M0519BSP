...
int main(void)
{
    ...
    printf("     P9.6 SPI1_MOSI <--> P9.5 SPI1_MISO \n");
    printf("\nSPI1 Loopback test ");
...
#if (!Slave3WireMode)
    printf("    SPI0_SS  (P2.6)   <->   SPI1_SS  (P9.7)\n");
#endif
    printf("    SPI0_CLK (P2.7)   <->   SPI1_CLK (P9.4)\n");
    printf("    SPI0_MISO(P5.1)   <->   SPI1_MISO(P9.5)\n");
    printf("    SPI0_MOSI(P5.0)   <->   SPI1_MOSI(P9.6)\n\n");
