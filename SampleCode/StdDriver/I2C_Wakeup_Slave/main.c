 ...
 * $Date: 15/07/08 9:58a $
 * @brief
 *           Show how to wake up MCU from Power-down mode through I2C0 interface.
...
static volatile I2C_FUNC s_I2CSlvHandlerFn = NULL;
...
void I2C0_IRQHandler(void)
{
    ...
    /* Check I2C0 Wake-up interrupt flag set or not */
    if(I2C_GET_WAKEUP_FLAG(I2C0))
    {
        /* Clear I2C0 Wake-up interrupt flag */
    ...
    {
        if(s_I2CSlvHandlerFn != NULL)
            s_I2CSlvHandlerFn(u32Status);
    }
}
/*---------------------------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------------------------*/
/*  I2C0 Slave Transmit/Receive Callback Function                                                          */
/*---------------------------------------------------------------------------------------------------------*/
...
int32_t main(void)
{
    ...
    /*
        This sample code is I2C0 SLAVE mode
    */
    printf("\n");
    printf("+----------------------------------------------------------------------+\n");
    printf("| M0519 I2C Driver Sample Code (Slave) for wake-up & access Slave test |\n");
    printf("|                                                                      |\n");
    printf("| I2C Master (I2C0) <---> I2C Slave(I2C0)                              |\n");
    printf("+----------------------------------------------------------------------+\n");

    printf("Configure I2C as a slave.\n");
    printf("The I/O connection for I2C:\n");
    printf("I2C_SDA(P3.4), I2C_SCL(P3.5)\n");
    ...
    /* I2C0 function to Transmit/Receive data as slave */
    s_I2CSlvHandlerFn = I2C_SlaveTRx;
