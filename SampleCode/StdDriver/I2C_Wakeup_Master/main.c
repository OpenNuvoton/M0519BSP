...
static volatile I2C_FUNC s_I2CMstHandlerFn = NULL;
...
void I2C0_IRQHandler(void)
{
    ...
    {
        if(s_I2CMstHandlerFn != NULL)
            s_I2CMstHandlerFn(u32Status);
    }
}
...
void SYS_Init(void)
{
    ...
    /* Set GP3 multi-function pins for I2C SDA and SCL */
...
int32_t I2C_Read_Write_SLAVE(uint8_t slvaddr)
{
    ...
    for(i = 0; i < 0x100; i++)
    {
        ...
        s_I2CMstHandlerFn = (I2C_FUNC)I2C_MasterTx;
        ...
        s_I2CMstHandlerFn = (I2C_FUNC)I2C_MasterRx;
...
int32_t main(void)
{
    ...
    /*
        This sample code sets I2C0 bus clock to 100kHz. After wake-up, then accesses Slave with Byte
        Write and Byte Read operations, and check if the read data is equal to the programmed data.
    */

    printf("+-----------------------------------------------------------------------+\n");
    printf("| M0519 I2C Driver Sample Code (Master) for wake-up & access Slave test |\n");
    printf("|                                                                       |\n");
    ...
    printf("\n");
    printf("Check I2C0 slave at power down status.\n");
    ...
    /* I2C0 function to wake-up slave*/
    s_I2CMstHandlerFn = (I2C_FUNC)I2C_MasterTxWakeup;
    ...
    I2C_Read_Write_SLAVE(0x15);
    I2C_Read_Write_SLAVE(0x35);
    I2C_Read_Write_SLAVE(0x55);
    I2C_Read_Write_SLAVE(0x75);
    ...
    printf("\n");
    printf(" == Mask Address ==\n");
    I2C_Read_Write_SLAVE(0x15 & ~0x01);
    I2C_Read_Write_SLAVE(0x35 & ~0x04);
