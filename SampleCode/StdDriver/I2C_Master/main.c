 ...
 * $Date: 15/07/08 9:58a $
 * @brief
 *           Show a I2C0 Master how to access Slave.
...
int32_t main(void)
{
    ...
    /*
        This sample code sets I2C0 bus clock to 100kHz. Then, Master accesses Slave with Byte Write
        and Byte Read operations, and check if the read data is equal to the programmed data.
    */
    printf("\n");
    printf("+--------------------------------------------------------+\n");
    printf("| M0519 I2C0 Driver Sample Code(Master) for access Slave |\n");
    printf("|                                                        |\n");
