 ...
 * $Date: 15/07/08 9:58a $
 * @brief
 *           Show how a Master uses I2C0 address 0x0 to write data to Slave.
...
int32_t main(void)
{
    ...
    /*
        This sample code sets I2C0 bus clock to 100kHz. Then, accesses Slave (GC Mode) with Byte Write
        and Byte Read operations, and check if the read data is equal to the programmed data.
    */
    printf("\n");
    printf("+-----------------------------------------------------------------+\n");
    printf("| M0519 I2C Driver Sample Code (Master) for access Slave (GC Mode)|\n");
    printf("|                                                                 |\n");
