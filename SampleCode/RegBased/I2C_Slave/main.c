 ...
 * $Date: 15/07/08 9:58a $
 * @brief
 *           Show how to set I2C0 in Slave mode and receive the data from Master.
...
int32_t main(void)
{
    ...
    */
    ...
    printf("+------------------------------------------------------+\n");
    printf("| M0519 I2C Driver Sample Code(Slave) for access Slave |\n");
    printf("|                                                      |\n");
    ...
    printf("\n");
    printf("I2C0 Slave Mode is Running.\n");
