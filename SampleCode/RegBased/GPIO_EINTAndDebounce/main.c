 ...
 * @return      None
 *
 * @details     The External INT0(P3.2) default IRQ, declared in startup_M0519.s.
 */
 ...
 * @return      None
 *
 * @details     The External INT1(P3.3) default IRQ, declared in startup_M0519.s.
 */
...
void SYS_Init(void)
{
    ...
    /* Set P3 multi-function pins for UART0 RXD, UART0 TXD, INT0 and INT1 */
    SYS->P3_MFP &= ~(SYS_MFP_P30_Msk | SYS_MFP_P31_Msk | SYS_MFP_P32_Msk | SYS_MFP_P33_Msk);
    SYS->P3_MFP |= (SYS_MFP_P30_UART0_RXD | SYS_MFP_P31_UART0_TXD | SYS_MFP_P32_INT0 | SYS_MFP_P33_INT1);
