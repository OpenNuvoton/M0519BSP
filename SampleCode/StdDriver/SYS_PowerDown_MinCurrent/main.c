...
int32_t main(void)
{
    ...
    /*
        ...
        On NuTiny-SDK-M0519 V1.0 board, remove components, e.g. Nu-Link-Me, R9 and R10.
    */
    ...
    SYS->P1_MFP = 0;
    SYS->P2_MFP = 0;
    SYS->P3_MFP = SYS_MFP_P31_UART0_TXD;
    SYS->P4_MFP = 0;
    SYS->P5_MFP = 0;
    SYS->P6_MFP = 0;
    SYS->P7_MFP = 0;
    ...
    GPIO_SetMode(P5, GPIO_0_TO_7, GPIO_PMD_QUASI);
    GPIO_SetMode(P6, GPIO_0_TO_7, GPIO_PMD_QUASI);
    GPIO_SetMode(P7, GPIO_0_TO_7, GPIO_PMD_QUASI);
    GPIO_SetMode(P8, GPIO_0_TO_7, GPIO_PMD_QUASI);
    GPIO_SetMode(P9, GPIO_0_TO_7, GPIO_PMD_QUASI);
    GPIO_SetMode(PA, GPIO_0_TO_7, GPIO_PMD_QUASI);
